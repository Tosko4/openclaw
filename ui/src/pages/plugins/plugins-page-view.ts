                ...
                catalogDetail
                  ...
                  : renderSettingsPage(
                      renderPluginCatalogResults({
                        ...
                        categories: discovery.categories.items,
                        categoriesError: discovery.categories.error,
                        featured: discovery.featured.items,
                        featuredLoading: discovery.featured.loading,
                        featuredError: discovery.featured.error,
                        trending: discovery.trending.items,
                        trendingLoading: discovery.trending.loading,
                        trendingError: discovery.trending.error,
                        ...
                        onRetryGrouped: () => {
                          void Promise.all([
                            discovery.refresh(),
                            discovery.featured.refresh(),
                            discovery.trending.refresh(),
                          ]);
                        },
                        onRetryCategories: () => void discovery.categories.refresh(),
                      }),
