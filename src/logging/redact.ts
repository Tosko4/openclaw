...
function redactBuiltInText(text: string): string {
  return redactFormBody(redactAssignmentValues(redactStructuredAuthHeaders(text, "***"), "url"));
}
...
export function redactText(
  ...
  let next = redactBuiltInText(text);
