 ...
 * The inspection API shipped in v2026.9.2; participation does not authorize room invocation.
 */
...
/**
 * Keep the published participation view shared across independently loaded send paths.
 */
