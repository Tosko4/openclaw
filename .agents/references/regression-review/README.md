...
| --------------------------------------------------------------------------------- | ----------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------: |
| A cutover changes what an existing consumer receives                              | [R1: Contract propagation](contracts.md)        | The actual consumer receives its required fact or artifact                                           |                                  6 |
| Work or identity changes owner, survives replacement, or completes asynchronously | [R2: Ownership across completion](ownership.md) | Pending work keeps a live owner; valid successors proceed and unrelated installations remain refused |                                  5 |
...
| A deadline, scan, snapshot, or probe assumes a workload shape                     | [R4: Workload assumptions](workload.md)         | The supported workload completes or receives a justified refusal                                     |                                  3 |
